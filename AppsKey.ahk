...
; From: https://www.autohotkey.com/board/topic/25393-appskeys-a-suite-of-simple-utility-hotkeys/
;
; AppsKey plus - Result
;
...
AppsKey & u:: ;Title Case Capitalize Capitalise Every word in Highlighted Text Sentence
Send ^c
Sleep, 150
StringReplace, Clipboard, clipboard, _, %A_Space%-%A_Space%, All
