...
^5:: ;Sherry AFCU login
    If WinActive("America First Credit Union")
    {
        ...
        Send, {Enter}
        Sleep 400
        Sendraw, 5Gjk3WvW77jb65H7w3hMmcCH
        Send, {Enter}
    }
Return
...
HotStrings:
    ...
    :*:jjt::jjt-0837{enter}
:*:@ahk::
    Clipboard:="AutoHotKey" ; *=don't require a white-space character (tab, space, return)
    Send ^v
Return

::lorem::
    Clipboard:="Remember, a Jedi can feel the Force flowing through him. You mean it controls your actions? Partially. But it also obeys your commands."
    Send ^v
Return
