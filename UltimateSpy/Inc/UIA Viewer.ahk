...
class IUIAutomationElement extends UIA.IUIAutomationBase {
    ...
    Highlight(showTime:=unset, color:="Red", d:=2) {
        ...
        Loop 4 {
            ...
            Guis[this.ptr][i].BackColor := A_IsAdmin ? "Red":"Green"
...
class Viewer {
    ...
    __New() {
        ...
        this.gViewer.Add("Text", "x+m yp w200 vAdminCheck cRed", "").SetFont("bold")
    ...
    CaptureCycle() {
        ...
        if IsProcessElevated(WinGetPID(mwid))
            this.gViewer['AdminCheck'].value := '(Admin Mode Detected)'
        else
            this.gViewer['AdminCheck'].value := ''
